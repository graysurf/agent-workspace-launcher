...
- PR: https://github.com/graysurf/codex-workspace-launcher/pull/4
...
| 25 | auth_codex_profile | `auth codex --profile CODEX_PROFILE ws-e2e` | `CWS_E2E_ENABLE_AUTH`, `CWS_E2E_ENABLE_CODEX`, `CWS_E2E_CODEX_PROFILE` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | PASS | 2026-01-21T07:51:04+0800 | `out/tests/e2e/cli/auth_codex_profile/meta.json` |
