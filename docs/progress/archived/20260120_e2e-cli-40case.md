# agent-workspace-launcher: CLI E2E 40-case matrix

| Status | Created | Updated |
| --- | --- | --- |
| DONE | 2026-01-20 | 2026-01-21 |

Links:

- PR: https://github.com/graysurf/agent-workspace-launcher/pull/4
...
- GitHub token (for GitHub auth / private repo): `CWS_E2E_GH_TOKEN=...` (e2e maps to `GH_TOKEN`) or set `GH_TOKEN`/`GITHUB_TOKEN` directly
- Auth cases: `CWS_E2E_ENABLE_AUTH=1`
- Codex auth case: `CWS_E2E_ENABLE_CODEX=1 CWS_E2E_AGENT_PROFILE=<profile>`
...
| 12 | create_public_ssh_scp_style | `create git@github.com:OWNER/REPO.git` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_ENABLE_SSH` | SKIP (needs `CWS_E2E_ENABLE_SSH=1`) | PASS | 2026-01-21T06:56:47+0800 | `out/tests/e2e/cli/create_public_ssh_scp_style/meta.json` |
| 13 | create_public_ssh_url_style | `create ssh://git@github.com/OWNER/REPO.git` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_ENABLE_SSH` | SKIP (needs `CWS_E2E_ENABLE_SSH=1`) | PASS | 2026-01-21T06:57:25+0800 | `out/tests/e2e/cli/create_public_ssh_url_style/meta.json` |
...
| 15 | create_seed_private_repo | `create --private-repo OWNER/PRIVATE_REPO OWNER/REPO` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_PRIVATE_REPO` | SKIP (needs `CWS_E2E_PRIVATE_REPO`) | PASS | 2026-01-21T06:57:54+0800 | `out/tests/e2e/cli/create_seed_private_repo/meta.json` |
...
| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 23 | auth_github | `auth github ws-e2e` | `CWS_E2E_ENABLE_AUTH` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | PASS | 2026-01-21T07:27:26+0800 | `out/tests/e2e/cli/auth_github/meta.json` |
| 24 | auth_github_host | `auth github --host github.com ws-e2e` | `CWS_E2E_ENABLE_AUTH` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | PASS | 2026-01-21T07:27:48+0800 | `out/tests/e2e/cli/auth_github_host/meta.json` |
| 25 | auth_AGENT_profile | `auth codex --profile AGENT_PROFILE ws-e2e` | `CWS_E2E_ENABLE_AUTH`, `CWS_E2E_ENABLE_CODEX`, `CWS_E2E_AGENT_PROFILE` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | PASS | 2026-01-21T07:51:04+0800 | `out/tests/e2e/cli/auth_AGENT_profile/meta.json` |
| 26 | auth_gpg_key | `auth gpg --key GPG_KEY_ID ws-e2e` | `CWS_E2E_ENABLE_AUTH`, `CWS_E2E_ENABLE_GPG`, `CWS_E2E_GPG_KEY_ID` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | PASS | 2026-01-21T07:51:09+0800 | `out/tests/e2e/cli/auth_gpg_key/meta.json` |
...
| 30 | reset_private_repo | `reset private-repo ws-e2e --yes` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_PRIVATE_REPO` | SKIP (needs `CWS_E2E_PRIVATE_REPO`) | PASS | 2026-01-21T06:59:32+0800 | `out/tests/e2e/cli/reset_private_repo/meta.json` |

### Tunnel (3)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 31 | tunnel_foreground | `tunnel ws-e2e` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | PASS | 2026-01-21T07:00:10+0800 | `out/tests/e2e/cli/tunnel_foreground/meta.json` |
| 32 | tunnel_detach | `tunnel ws-e2e --detach` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | PASS | 2026-01-21T07:00:40+0800 | `out/tests/e2e/cli/tunnel_detach/meta.json` |
| 33 | tunnel_named | `tunnel ws-e2e --name ws-e2e-tunnel` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | PASS | 2026-01-21T07:03:06+0800 | `out/tests/e2e/cli/tunnel_named/meta.json` |
...
| 35 | rm_all_yes | `rm --all --yes` | `CWS_E2E_ALLOW_RM_ALL` | SKIP (needs `CWS_E2E_ALLOW_RM_ALL=1`) | PASS | 2026-01-21T07:07:56+0800 | `out/tests/e2e/cli/rm_all_yes/meta.json` |

### Env / config (5)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 36 | env_custom_image | `ls` (env: `CWS_IMAGE=graysurf/agent-workspace-launcher:latest`) | — | PASS | — | 2026-01-20T22:46:06+0800 | `out/tests/e2e/cli/env_custom_image/meta.json` |
