...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | help | `--help` | — | TODO | — | — | `out/tests/e2e/cli/help/meta.json` |
| 2 | help_auth | `auth --help` | — | TODO | — | — | `out/tests/e2e/cli/help_auth/meta.json` |
| 3 | help_create | `create --help` | — | TODO | — | — | `out/tests/e2e/cli/help_create/meta.json` |
| 4 | help_ls | `ls --help` | — | TODO | — | — | `out/tests/e2e/cli/help_ls/meta.json` |
| 5 | help_exec | `exec --help` | — | TODO | — | — | `out/tests/e2e/cli/help_exec/meta.json` |
| 6 | help_rm | `rm --help` | — | TODO | — | — | `out/tests/e2e/cli/help_rm/meta.json` |
| 7 | help_reset | `reset --help` | — | TODO | — | — | `out/tests/e2e/cli/help_reset/meta.json` |
| 8 | help_tunnel | `tunnel --help` | — | TODO | — | — | `out/tests/e2e/cli/help_tunnel/meta.json` |

### Create (9)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 9 | create_public_owner_repo | `create OWNER/REPO` | `CWS_E2E_PUBLIC_REPO` | TODO | — | — | `out/tests/e2e/cli/create_public_owner_repo/meta.json` |
| 10 | create_public_https | `create https://github.com/OWNER/REPO` | `CWS_E2E_PUBLIC_REPO` | TODO | — | — | `out/tests/e2e/cli/create_public_https/meta.json` |
| 11 | create_public_https_git_suffix | `create https://github.com/OWNER/REPO.git` | `CWS_E2E_PUBLIC_REPO` | TODO | — | — | `out/tests/e2e/cli/create_public_https_git_suffix/meta.json` |
...
| 14 | create_no_extras | `create --no-extras OWNER/REPO` | `CWS_E2E_PUBLIC_REPO` | TODO | — | — | `out/tests/e2e/cli/create_no_extras/meta.json` |
...
| 16 | create_no_work_repos_with_name | `create --no-work-repos --name ws-e2e` | — | TODO | — | — | `out/tests/e2e/cli/create_no_work_repos_with_name/meta.json` |
...
| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 18 | ls | `ls` | — | TODO | — | — | `out/tests/e2e/cli/ls/meta.json` |

### Exec (4)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 19 | exec_command | `exec ws-e2e git -C REPO_PATH status` | `CWS_E2E_PUBLIC_REPO` | TODO | — | — | `out/tests/e2e/cli/exec_command/meta.json` |
| 20 | exec_shell | `exec ws-e2e` | `CWS_E2E_ENABLE_EXEC_SHELL` | TODO | — | — | `out/tests/e2e/cli/exec_shell/meta.json` |
| 21 | exec_root | `exec --root ws-e2e id -u` | — | TODO | — | — | `out/tests/e2e/cli/exec_root/meta.json` |
| 22 | exec_user | `exec --user codex ws-e2e id -u` | — | TODO | — | — | `out/tests/e2e/cli/exec_user/meta.json` |
...
| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 34 | rm_workspace_yes | `rm ws-e2e --yes` | — | TODO | — | — | `out/tests/e2e/cli/rm_workspace_yes/meta.json` |
...
| 38 | env_auth_none | `ls` (env: `CWS_AUTH=none`) | — | TODO | — | — | `out/tests/e2e/cli/env_auth_none/meta.json` |
| 39 | env_docker_args_string | `ls` (env: `CWS_DOCKER_ARGS="-e FOO=bar -e BAZ=qux"`) | — | TODO | — | — | `out/tests/e2e/cli/env_docker_args_string/meta.json` |
| 40 | env_cws_bash_path | `ls` (env: `CWS_BASH_PATH=scripts/cws.bash`) | — | TODO | — | — | `out/tests/e2e/cli/env_cws_bash_path/meta.json` |
